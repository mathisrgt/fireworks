...
const yieldReaderContract: OmniPointHardhat = {
    eid: EndpointId.ARBITRUM_V2_MAINNET, // Deploy on Arbitrum
    contractName: 'YieldRateReader',
};

const config: OAppReadOmniGraphHardhat = {
    contracts: [
        {
            contract: yieldReaderContract,
            config: {
                readChannelConfigs: [
                    {
                        ...
                        enforcedOptions: [
                            {
                                ...
                                gas: 200000,
                                size: 1000, // Expected response size in bytes
                                value: 0,
                            },
                        ],
                    },
